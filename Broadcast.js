 const Discord = require("discord.js");
  const kboosh = new Discord.Client();
    const kbooshtoken = "NTIwOTk3NDY5MDk0Njc0NDMz.D2vBZQ.Vsp4lt_MIFcVs4zkZQQmfZheRHU"
      kboosh.on('ready', () => {
        kboosh.user.setGame(`BOT_TDM By L7aj Escobar`,'https://www.twitch.tv/mohamedaminegamer');
